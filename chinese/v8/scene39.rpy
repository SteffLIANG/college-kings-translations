...
translate chinese hosp_climb_seb_54999126:

    # u "What? No. It's just... what if someone sees us?"
    u "什么？不。只是……如果有人看到我们怎么办？"

# game/v8/scene39.rpy:30
translate chinese hosp_climb_seb_561d0a41:

    # se "True. But look man, no glory comes with zero risk."
    se "没错。但是听着，伙计，没有什么荣耀是零风险带来的。"

# game/v8/scene39.rpy:35
translate chinese hosp_climb_seb_84b427d3:
...
translate chinese climb_the_hos_8b21a17a:

    # se "This roof holds many secrets, one of them being the view."
    se "这个屋顶有很多秘密，其中之一就是风景。"
...
translate chinese watching_seb_climb_eb6bfa4b:

    # se "How's down there, little ant cub?"
    se "那里怎么样，小狼崽？"

# game/v8/scene39.rpy:301
translate chinese watching_seb_climb_b6d03f04:
...
translate chinese watching_seb_climb_bfd776c2:
    ...
    u "(真是太好了……我为什么要和他出去。只是为了保持警惕和让自己沉闷入睡？)"

# game/v8/scene39.rpy:316
translate chinese watching_seb_climb_d5a4ca17:
...
translate chinese watching_seb_climb_5b3f29f7:
