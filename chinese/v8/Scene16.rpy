...
translate chinese strings:
    ...
    # game/v8/Scene16.rpy:31
    old "Having fun with Ms. Rose at Hoco!"
    new "和罗斯女士在返校节玩得很开心！"

    # game/v8/Scene16.rpy:34
    ...
    # game/v8/Scene16.rpy:54
    old "Wish I could of been there to try things with you"
    new "希望我能在那里和你一起尝试"

    # game/v8/Scene16.rpy:55
    old "Looking good"
    new "看起来不错"

    # game/v8/Scene16.rpy:56
