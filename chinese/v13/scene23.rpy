...
# game/v13/scene23.rpy:22
translate chinese v13s23_daeaeb95:

    # u "So, are you guys ready?"
    u "你们准备好了吗？"

# game/v13/scene23.rpy:27
translate chinese v13s23_b21bbc29:

    # ry "I am... Imre's acting like he doesn't want me to come but, I'm on some \"fuck Imre\" vibes right now."
    ry "我没问题……伊姆雷表现得好像他不想让我来，但是，我现在有一些\"去他妈的伊姆雷\"共鸣。"

# game/v13/scene23.rpy:33
translate chinese v13s23_3428cc24:
    ...
    imre "我不想让你来，但是两个人是不够的，而且克里斯也不想出去。所以，我们才在这里。不是克里斯就是李先生，他现在有点忙。"

# game/v13/scene23.rpy:40
translate chinese v13s23_42b2727e:

    # ry "Oh yeah, what was all that yelling about? Did someone break one of his precious valuables or something?"
    ry "噢，是吗，她刚才在喊什么？有人弄坏了他的贵重物品吗？"

# game/v13/scene23.rpy:45
translate chinese v13s23_ef13a2ef:

    # imre "*Laughs* When I got there, Mr. Lee had Charli pinned to the ground..."
    imre "*笑* 当我到那里时，李先生把查理按倒在地上……"

# game/v13/scene23.rpy:51
translate chinese v13s23_609a801d:

    # u "Long story short, he won't be around anymore."
    u "长话短说，他不会再出现了。"

# game/v13/scene23.rpy:52
translate chinese v13s23_7a3882e4:

    # u "In fact, I'm pretty sure he's banned from San Vallejo. *Chuckles*"
    u "事实上，我很肯定他被圣瓦列霍开除了。 *咯咯笑*"

# game/v13/scene23.rpy:64
translate chinese v13s23_0de3b809:

    # imre "Shit, dude... You really got rid of that rat?"
    imre "天呐，伙计……你真的把那只老鼠赶走了？"

# game/v13/scene23.rpy:69
translate chinese v13s23_749e576b:

    # u "Hell yeah I did. He kind of did it to himself but, I just had to press the right button. *Chuckles*"
    u "妈的，是的，我就是这么做的。他有点自暴自弃，但是，我只需要送他一程。 *咯咯笑*"

# game/v13/scene23.rpy:75
translate chinese v13s23_f5676e34:

    # ry "Well, good. Now Imre can stop talking about how he's gonna kick his ass every day. *Chuckles*"
    ry "嗯，很好。现在伊姆雷不用天天说他要怎么揍他了。 *咯咯笑*"

# game/v13/scene23.rpy:80
translate chinese v13s23_26b0aaf6:

    # u "*Sighs* You guys really do go at it like a married couple, aren't you guys excited for this? I know I am!"
    u "*叹息* 你们俩真像一对夫妻，你们不兴奋吗？我知道我是！"

# game/v13/scene23.rpy:86
translate chinese v13s23_9fc7154f:

    # ry "Hell yeah, and Imre should be. Today he'll finally see a real girl."
    ry "该死的，是啊，伊姆雷应该是。今天他终于要见到一个真正的女孩了。"

# game/v13/scene23.rpy:91
translate chinese v13s23_b329e79b:

    # imre "Shut the fuck up."
    imre "闭嘴吧你。"

# game/v13/scene23.rpy:97
translate chinese v13s23_636a0944:

    # ry "*Laughs*"
    ry "*笑*"

# game/v13/scene23.rpy:102
translate chinese v13s23_60b57552:
