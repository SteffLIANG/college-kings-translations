...
translate chinese v9_sat_cafe_w_nora_2476391f:

    # no "It feels good to have a nice meal once in awhile."
    no "偶尔美餐一顿感觉真好。"

# game/v9/scene31.rpy:27
translate chinese v9_sat_cafe_w_nora_67cd3695:
...
translate chinese v9_sat_cafe_w_nora_f7ecc16b:
    ...
    u "我想你这样看是对的。不管怎样，你的伴侣应该是第一位的，尽管这一切现在看起来很重要，但都是暂时的。"

# game/v9/scene31.rpy:42
translate chinese v9_sat_cafe_w_nora_dd3f3a9e:

    # no "Wow, under that thick skull you're not as dull as the rest of those meat heads."
    no "哇，你厚厚的脑袋并不像其他的肉脑袋那么迟钝。"

# game/v9/scene31.rpy:47
translate chinese v9_sat_cafe_w_nora_c8e4e4ad:
...
translate chinese v9_sat_cafe_w_nora_f0c7c13c:

    # no "I had a really good time [name]. Wish I could do this more often."
    no "我吃得很开心，[name]。希望我能经常这样。"

# game/v9/scene31.rpy:105
translate chinese v9_sat_cafe_w_nora_8c6198f5:

    # u "Maybe we can."
    u "也许我们可以。"

# game/v9/scene31.rpy:110
translate chinese v9_sat_cafe_w_nora_44c2578a:

    # no "Maybe. See you around!"
    no "也许吧。回头见！"

# game/v9/scene31.rpy:115
translate chinese v9_sat_cafe_w_nora_18647189:

    # u "See ya!"
    u "再见！"

# game/v9/scene31.rpy:126
translate chinese v9_sat_cafe_w_nora_2027a26c_1:
...
translate chinese v9_sat_cafe_w_nora_f0c7c13c_1:

    # no "I had a really good time [name]. Wish I could do this more often."
    no "我吃得很开心，[name]。我玩得很开心。"

# game/v9/scene31.rpy:160
translate chinese v9_sat_cafe_w_nora_8c6198f5_1:

    # u "Maybe we can."
    u "也许我们可以。"

# game/v9/scene31.rpy:165
translate chinese v9_sat_cafe_w_nora_44c2578a_1:

    # no "Maybe. See you around!"
    no "也许吧。回头见！"

# game/v9/scene31.rpy:170
translate chinese v9_sat_cafe_w_nora_18647189_1:

    # u "See ya!"
    u "再见！"

# game/v9/scene31.rpy:181
translate chinese v9_sat_cafe_e37871c5:

    # u "(I actually can't believe how hungry I am.)"
    u "(我真不敢相信我有多饿。)"

# game/v9/scene31.rpy:186
translate chinese v9_sat_cafe_c68fb736:
...
translate chinese v9_sat_cafe_cf7579f5:
