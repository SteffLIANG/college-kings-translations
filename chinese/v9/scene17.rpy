...
translate chinese v9_room_fri_morn_eef583a3:

    # ch "Wake up [name], Wolves aren't nocturnal. Go be productive. And someone sent you some mail Mr. Popular."
    ch "醒醒，[name]，狼不是夜间活动的。去做保持高效的人。有人给你发了邮件，受欢迎的先生。"

# game/v9/scene17.rpy:16
translate chinese v9_room_fri_morn_8da0ae81:

    # u "Early bird gets the worm and yada yada yada."
    u "早起的鸟儿有虫吃。"

# game/v9/scene17.rpy:21
translate chinese v9_room_fri_morn_4471b800:

    # ch "Right!"
    ch "对！"

# game/v9/scene17.rpy:35
translate chinese v9_room_fri_morn_db7a4e2e:
    ...
    u "(这学期你已经不仅仅是一个学生，还是一个真正的知己。我希望我能有机会回报你。非常感谢，罗斯小姐。)"
...
translate chinese s17_PhoneContinueW_68aafa48:

    # gr "Good."
    gr "很好。"

# game/v9/scene17.rpy:81
translate chinese s17_PhoneContinueW_347d66bc:

    # u "(Is this guy my fucking dad? Jesus.)"
    u "(这家伙是我该死的爸爸吗？天啊。)"

# game/v9/scene17.rpy:96
translate chinese s17_PhoneContinueA_8e7cf5c5:

    # u "(I should text Lauren.)"
    u "(我应该给劳伦发短信。)"

# game/v9/scene17.rpy:99
translate chinese s17_PhoneContinueA_23ba1da1:
...
translate chinese strings:
    ...
    new "嘿，你愿意来我宿舍帮我吗?我的小鹿入会仪式需要帮助。她们想让我帮忙她们一年一度的慈善日活动。"
