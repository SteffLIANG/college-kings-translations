...
translate chinese v12_simplr_convo_0fa55aff:
    ...
    u "(我需要睡一觉才能忘掉这一切，但我现在有点清醒。我就去看看我的手机。)"
...
translate chinese v12_simplr_convo_2e66f1eb:

    # u "(Haven't checked out Simplr in a while.)"
    u "(已经有一段时间没有看看简约了。)"

# game/v12/scene24.rpy:60
translate chinese v12s24_PhoneContinueEmmy_581b2cbc:

    # u "(I should check Simplr.)"
    u "(我该看看简约了。)"

# game/v12/scene24.rpy:66
translate chinese v12s24_PhoneContinueEmmy_c0f47f91:

    # u "(Very interesting... *Chuckles* Now, I need to sleep.)"
    u "(非常有趣…… *咯咯笑* 现在，我需要睡觉了。)"

# game/v12/scene24.rpy:72
translate chinese v12s24_PhoneContinueEmmy_89080957:
